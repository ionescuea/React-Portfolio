    ...
    <div className="container py-2">
      ...
      <ul className="projects-list d-flex justify-content-around align-items-center flex-wrap p-0">
        <li>
          ...
          <ProjectItem title="Charts App" image_url="charts-app.jpg" project_url="https://another-charts-app.netlify.app/" github_url="https://github.com/ionescuea/Charts-App" tech="React, Recharts, Node.js, API's" description="Charts" />
