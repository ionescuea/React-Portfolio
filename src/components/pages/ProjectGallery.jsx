  ...
  <div className="mb-5">
    ...
    <div className="container py-2">
      ...
      <ul className="projects-list d-flex justify-content-around align-items-center flex-wrap p-0">
        <li>
          <ProjectItem title="Chat App - work in progress -" image_url="chat-app.jpg" project_url="https://anotherchatapp.netlify.app/" github_url="https://github.com/ionescuea/ChatApp-React" tech="React, Websockets, Node.js" description="A chat application with role based permissions that allows users to login and chat with other users" />
