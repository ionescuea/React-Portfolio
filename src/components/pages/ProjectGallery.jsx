  ...
  <div className="mb-5">
    ...
    <div className="container py-2">
      ...
      <ul className="projects-list d-flex justify-content-around align-items-center flex-wrap p-0">
        <li>
          <ProjectItem title="Charts App" status="work-in-progress" image_url="coming-soon.jpg" github_url="https://github.com/ionescuea/Charts-App" tech="React, ECharts, Node.js, API's" description="Charts" />
          <ProjectItem title="Task Tracker" image_url="task-tracker.jpg" project_url="https://github.com/ionescuea/Task-Tracker" github_url="https://github.com/ionescuea/Task-Tracker" tech="React, Node.js, Express, MongoDB, Axios, React, Bootstrap" description="A full-stack task management application built with React and Node.js + Express. Users can create, view, update, and delete tasks, with data persisted on the backend." />
