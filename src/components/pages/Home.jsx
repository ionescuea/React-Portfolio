...
const Home = () => (
  <div className="container">
    <div className="row">
      <div className="col-4">
        <div className="h1 mt-5 mb-5 pb-5 pt-5">
          Hello and welcome to my portfolio!
        </div>
        <div className="intro card mt-5 shadow-lg p-3 mb-5 rounded fw-semibold bg-light">
      ...
      <div className="col-4">
        <img src="src/assets/alex-photo.jpg" alt="Alex's picture" className="rounded-5 mx-auto d-block img-thumbnail mt-3 p-0"></img>
      </div>
